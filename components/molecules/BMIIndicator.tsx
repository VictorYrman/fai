  ...
  return (
    <View style={BMIIndicatorStyles.bmiIndicator}>
      <View style={BMIIndicatorStyles.bmiIndicatorContent}>
        <View
          style={[
            BMIIndicatorStyles.bmiIndicatorElement,
            BMIIndicatorStyles.bmiIndicatorElementInsufficient,
          ]}
        ></View>
        <View
          style={[
            BMIIndicatorStyles.bmiIndicatorElement,
            BMIIndicatorStyles.bmiIndicatorElementNormal,
          ]}
        ></View>
        <View
          style={[
            BMIIndicatorStyles.bmiIndicatorElement,
            BMIIndicatorStyles.bmiIndicatorElementRedundant,
          ]}
        ></View>
        <View
          style={[
            BMIIndicatorStyles.bmiIndicatorElement,
            BMIIndicatorStyles.bmiIndicatorElementFatness,
          ]}
        ></View>
        <View
          style={[
            BMIIndicatorStyles.bmiIndicatorElement,
            BMIIndicatorStyles.bmiIndicatorElementExtremeDegree,
          ]}
        ></View>

        <View
          style={[BMIIndicatorStyles.slider, { left: `${percentage}%` }]}
        ></View>
      </View>
