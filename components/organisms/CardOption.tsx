...
import Advice, { AdviceType } from "../molecules/Advice";
...
const CardOption = ({
  ...
  return (
    <Pressable
      ...
      style={[
        CardOptionStyles.cardOption,
        isSelected ? CardOptionStyles.cardOptionSelected : null,
      ]}
    >
      <Image
      ...
      <View style={CardOptionStyles.statusContainer}>
        {advice && <Advice type={advice.type} title={advice.title} />}
